  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="text-center md:text-large lg:text-xl text-white/60 mt-4 max-w-md mx-auto">See how i transformed concepts into engaging digital experiences.</p>

        <div className="flex flex-col mt-10 md:mt-20 gap-20">
          {portfolioProjects.map((project) => (
            <div key={project.title} className="bg-gray-800 rounded-3xl relative overflow-hidden z-0 after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 pt-8 px-8 pb-0 md:pt-12 md:px-10 lg:pt-16 lg:px-20 after:pointer-events-none">
